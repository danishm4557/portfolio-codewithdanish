      ...
      <div className="navigation-container absolute top-0 left-0 z-20 text-white flex justify-center bg-transparent w-full pt-5">
        <div className="flex w-11/12 justify-between items-center">
          <div className="left-logo-container">
            <img src={danishLogoBold} alt="Danish Logo" className="danish-logo-bold-image" />
          </div>
          {/* mobile */}
          <div className="right-hamburger-icon-container flex md:hidden gap-3">
            <label htmlFor="menu-toggle" className="menu-button-icon relative w-7 h-5"></label>
            <input
              name="menu-toggle"
              type="checkbox"
              id="menu-toggle"
          ...
          {/* desktop */}
          <div className="right-links-container hidden md:flex gap-3">
            {/* LINKEDIN */}
            <a
              href="https://www.linkedin.com/in/danishmohiuddin/"
              target="_blank"
              className="button bg-[#222222] hover:bg-[#0077B5] rounded-full w-10 h-10 flex justify-center items-center transition-colors duration-300"
            >
              <svg
                width="14px"
                height="14px"
            ...
            {/* GITHUB */}
            <a
              href="https://github.com/danishm4557"
              target="_blank"
              className="button bg-[#222222] hover:bg-white rounded-full w-10 h-10 flex justify-center items-center transition-colors duration-300 group"
            >
              <svg
                width="20px"
                height="20px"
            ...
            {/* EMAIL */}
            <a
              href="mailto:danishm4557@gmail.com"
              className="button bg-[#222222] hover:bg-red-500 rounded-full w-10 h-10 flex justify-center items-center transition-colors duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
